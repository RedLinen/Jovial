...
/* Note lengths */
#define MEASURE_TIME              (u16)(2048 + 1280) /* Time in ms for 1 measure (1 full note) - should be divisible by 16 */
#define FULL_NOTE                 (u16)(MEASURE_TIME)
#define HALF_NOTE                 (u16)(MEASURE_TIME / 2)
#define QUARTER_NOTE              (u16)(MEASURE_TIME / 4)
#define DOT_QUARTER_NOTE           (u16)(MEASURE_TIME / 4) + (u16)(MEASURE_TIME / 8)
#define EIGHTH_NOTE               (u16)(MEASURE_TIME / 8)
#define TRIP_EIGTH_NOTE           (u16)(277)

#define DOT_EIGHT_NOTE            ((u16)(MEASURE_TIME / 8) + (u16)(MEASURE_TIME / 16))

#define SIXTEENTH_NOTE            (u16)(MEASURE_TIME / 16)

#define DOT_SIXTEENTH_NOTE        (u16)(MEASURE_TIME / 16) + (u16)(MEASURE_TIME / 32)
...
#define ND4                       DOT_QUARTER_NOTE
#define N8                        EIGHTH_NOTE  
#define NT8                       TRIP_EIGTH_NOTE
#define ND8                       DOT_EIGHT_NOTE 
#define N16                       SIXTEENTH_NOTE   
#define ND16                      DOT_SIXTEENTH_NOTE
#define N32                       THIRTYSECOND_NOTE
